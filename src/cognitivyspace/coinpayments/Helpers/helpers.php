...
if (!function_exists('validate_eth_address')) {
     ...
     * @param $address
     * @return bool
     * @throws \CognitivySpace\Coinpayments\Exceptions\InvalidHashException
     */
    function validate_eth_address($address)
    {
        ...
        throw new \CognitivySpace\Coinpayments\Exceptions\InvalidHashException('Invalid ETH address');
    }
}
...
if (!function_exists('is_eth_address')) {
    ...
    {
        $validator = new \CognitivySpace\Coinpayments\Validators\EthereumValidator();
