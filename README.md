...
```
composer require cognitivyspace/coinpayments
```
...
$app->register(\CognitivySpace\Coinpayments\Providers\CoinpaymentsServiceProvider::class);
```
...
'providers' => [
    ...
    \CognitivySpace\Coinpayments\Providers\CoinpaymentsServiceProvider::class,
],
```
...
```php
     ...
     */
    protected $listen = [
        CognitivySpace\Coinpayments\Events\Deposit\DepositComplete::class => [
